...
// el main es el encargado de recibir el input del usuario y verificar que este sea valido, si es exitoso
// llama a la subrutina create_threads encargada de crear los hilos y pasa como argumento el tread_count
...
int main(int argc, char* argv[]) {
  ...
  if (argc == 2) {
    if (sscanf(argv[1], "%" SCNu64, &thread_count) == 1) {
      ...
      return 11; // usamos numeros de error como 11, 1 = primer subrutina, el otro 1 = primero error
    }
  }
