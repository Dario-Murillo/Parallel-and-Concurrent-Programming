...
const char* const usage =
  ...
  "  buffer_size  maximum packages that cna be stored in queue\n"
  "\n"
...
int ProducerConsumerTest::analyzeArguments(int argc, char* argv[]) {
  ...
  this->bufferSize = std::atoi(argv[index++]);
